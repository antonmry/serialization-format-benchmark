...
public final class KeyValue extends Table {
  ...
  public AnyValue value() { return value(new AnyValue()); }
  public AnyValue value(AnyValue obj) { int o = __offset(6); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
