...
public class KeyValue implements org.apache.thrift.TBase<KeyValue, KeyValue._Fields>, java.io.Serializable, Cloneable, Comparable<KeyValue> {
  ...
  public @org.apache.thrift.annotation.Nullable AnyValue value; // required
  ...
  public KeyValue(KeyValue other) {
    ...
    if (other.isSetValue()) {
      this.value = new AnyValue(other.value);
    }
  }
  ...
  public KeyValue setValue(@org.apache.thrift.annotation.Nullable AnyValue value) {
    this.value = value;
    return this;
  }
